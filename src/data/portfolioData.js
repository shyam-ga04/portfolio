...
export const portfolioData = {
  ...
  experience: [
    {
      ...
      points: [
        "Built and maintained a production React Native mobile application with real-time chat, push notifications, and session management.",
    ...
    },
    {
      ...
      points: [
        "Contributed to mobile and web applications using React Native, React.js, and NestJS.",
  ...
  projects: [
    ...
    {
      name: "App Hero",
      stack: ["React Native", "React.js", "NestJS", "AWS", "PostgreSQL"],
      points: [
